...
namespace DES_.Net_Core
{
    ...
    {
        internal static readonly IList<int> PC1 = new List<int>
        {
            57, 49, 41, 33, 25, 17, 9,
            1, 58, 50, 42, 34, 26, 18,
            10, 2, 59, 51, 43, 35, 27,
        ...
        internal static readonly IList<int> PC2 = new List<int>
        {
            14, 17, 11, 24, 1, 5,
            3, 28, 15, 6, 21, 10,
            23, 19, 12, 4, 26, 8,
        ...
        internal static readonly IList<int> IP = new List<int>
        {
        ...
        internal static readonly IList<int> E = new List<int>
        {
            32, 1, 2, 3, 4, 5,
            4, 5, 6, 7, 8, 9,
            8, 9, 10, 11, 12, 13,
        ...
        internal static readonly List<IList<IList<int>>> S = new List<IList<IList<int>>>
        {
            new List<IList<int>>
            {
        ...
        internal static readonly IList<int> P = new List<int>
        {
            16, 7, 20, 21,
            29, 12, 28, 17,
            1, 15, 23, 26,
        ...
        internal static readonly IList<int> IP2 = new List<int>
        {
        ...
        internal static readonly IList<int> SHIFTS = new List<int> { 1, 1, 2, 2, 2, 2, 2, 2, 1, 2, 2, 2, 2, 2, 2, 1 };
    }
}